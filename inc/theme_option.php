...
Redux::setSection($opt_name, array(
 ...
 'fields' => array(
    array(
        'id' => 'theme_slider_background',
         'title' => 'Theme Slider Background',
         'type'  => 'media',
    ),
...
Redux::setSection($opt_name, array(
  'title' => 'Theme slider Blockquote',
  'id'    => 'theme_blockquote_1',
  'icon' => 'el el-rss',
 'fields' => array(
        array(
        'id' => 'theme_blockquote_name',
         'title' => 'Theme blockquote Name',
         'type'  => 'text',
    ), 
    array(
        'id' => 'theme_blockquote_field',
         'title' => 'Theme blockquote Field',
         'type'  => 'textarea',
    ), 
  array(
        'id' => 'theme_blockquote_icon',
         'title' => 'Theme blockquote Icon',
         'type'  => 'text',
    ), 
